...
namespace AspNet6.Web.AppLib.Tools
{
    // Internals
    ...
    public partial class JWTFactory
    {
        ...
        public TokenValidationParameters FactoryTokenValidationParameters(string validAudience = "*", int clockSkew = 1)
            => GetTokenValidationParameters(validAudience, clockSkew);
    }
}
