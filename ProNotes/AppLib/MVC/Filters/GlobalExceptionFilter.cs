    ...
    public class GlobalExceptionFilter : ExceptionFilterAttribute
    {
        ...
        private bool Is_WebAPI()
        {
            ...
            if (actionDescriptor != null &&
                actionDescriptor.ControllerTypeInfo.IsSubclassOf(typeof(ControllerBase)) &&
                !actionDescriptor.ControllerTypeInfo.IsSubclassOf(typeof(Controller)))
                return true;
            else
                return false;
        }
        ...
        private string ExceptionAsJson()
        {
            ...
            if (_context?.Exception?.Data != null)
            {
                foreach (DictionaryEntry data in _context.Exception.Data)
                {
#pragma warning disable CS8604 // Possible null reference argument.
                    if (data.Key != null) { error.Add(data.Key.ToString(), data.Value?.ToString() ?? string.Empty); }
